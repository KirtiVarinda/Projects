 ...
 */
public class GetFixrNumberXmlParser {
    private static final String ns = null;

    // We don't use namespaces

    public List<Numbers> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<Numbers> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (name.equals("phones")) {
                Numbers.add(readNumbers(parser));
            } else {
                skip(parser);
            }
        }
    ...
    private Numbers readNumbers(XmlPullParser parser) throws XmlPullParserException, IOException {
        parser.require(XmlPullParser.START_TAG, ns, "phones");
        String number = null;
