    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                if(null != mmDevice   &&  null != mmDevice.getUuids()[0].getUuid() ) {
                    System.out.println("aaaaa" + mmDevice);
                    System.out.println("aaaaa" + mmDevice.getUuids()[0].getUuid());
                    uuid = mmDevice.getUuids()[0].getUuid();

                    System.out.println("dshcfgduygfvir" + uuid);
