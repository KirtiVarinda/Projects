...
public class Theme implements EditItem {
	...
	public Theme(ThemeColors colors) {
		myColors = colors;
	}

	public static Theme A(Context a, ThemeColors colors) {
	...
	public void setAllTextStylesTo(TextStyle t) {
		headerText1 = t;
		headerText2 = t;
		normalText1 = t;
		normalText2 = t;
	...
	public static Theme B(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
	...
	public static Theme C(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
		theme.backgroundButtons1 = ThemeBackground.B1();
	...
	public static Theme D(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static Theme E(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static Theme F(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static Theme G(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static Theme H(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static Theme I(Context a, ThemeColors colors) {
		Theme theme = new Theme(colors);
		// theme.backgroundMainContainer = ThemeBackground.B2();
	...
	public static class TextStyle {
		 ...
		 * @return
		 */
		public static TextStyle GiantHead(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Pony(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Gothic(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Disko(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle GiantHead2(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Grumble(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Scars(Context a, float size) {
			TextStyle s = new TextStyle();
		...
		public static TextStyle Scars2(Context a, float size) {
			TextStyle s = new TextStyle();
	...
	public static class ThemeBackground {
		...
		public static ThemeBackground B1() {
			ThemeBackground b = new ThemeBackground();
