package com.example.kirti_pc.droidar.v2.simpleUi.util;
...
public abstract class DragAndDropListener implements OnTouchListener {
	...
	private ImageView getImageView(View source, Activity activity,
		...
		if (imageView == null) {
			final Bitmap bitmap = v2.simpleUi.util.IO.loadBitmapFromView(source);
	...
	private LayoutParams getDragDropContainerParams(
			Context context) {
		if (params == null) {
