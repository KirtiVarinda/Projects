...
/**
 * An example how to implement a {@link v2.simpleUi.uiDecoration.UiDecorator}. To simplify things the
...
public class ExampleDecorator extends DefaultUiDecorator {
	...
	public boolean decorate(Context context, View targetView, int level,
			int type) {
		if (type == v2.simpleUi.uiDecoration.UiDecorator.TYPE_CONTAINER && level > 2) {
